...
boxBo (box){ shape=ssBox, Q=<t(.0 .1 0)>, size=[1.5 2.8 .3 .04],  contact }

#boxTo (box){ shape=ssBox, Q=<t(.0 0 1.5)>, size=[1.5 2. .1 .04], color=[.2 .2 .2 .3]  contact }

boxLe (box){ shape=ssBox, Q=<t(-.75 0 .75) d(90 0 1 0)>, size=[1.5 2. .1 .04], contact }

#boxRe (box){ shape=ssBox, Q=<t( .75 0 .75) d(90 0 1 0)>, size=[1.5 2. .1 .04], color=[.2 .2 .2 .3] contact }

boxBa (box){ shape=ssBox, Q=<t(0 1. .75) d(90 1 0 0)>, size=[1.5 1.5 .1 .04], contact }
